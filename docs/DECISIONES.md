...
6. **Colores reales** (backup de base de datos UpdraftPlus, 25/09/2026): `#0084d6` acento, `#0075be` hover, `#000000` títulos, `#333333` texto, `#f5f7f9` fondo de secciones, `#e2e2e2` bordes. Cambiar: variables `--c0…--c7` al inicio de `site/assets/css/styles.css`.
7. **Tipografía real: Lato** (400 texto, 700 títulos), según `astra-settings`. Botones con radio 15 px como en Astra. Copyright igual al del footer original ("Copyright © año EXE | Tel +54 9 11 3009 5254").
